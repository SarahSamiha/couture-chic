...
const Home = () => {
    ...
    return (
        <div>
            ...
            {/* Contact us */}
            <div className="hero lg:h-[500px] mt-14 lg:rounded-2xl lg:max-w-6xl mx-auto mb-12" style={{ backgroundImage: 'url(https://i.ibb.co/QKyDS0j/martin-martz-z-Ea54wu6-IYY-unsplash.jpg)' }} data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                <div className="hero-overlay bg-opacity-60 lg:rounded-2xl"></div>
                <div className="hero-content text-center text-neutral-content" data-aos="fade-up" data-aos-duration="3000">
                    <div className="lg:max-w-4xl">
                        ...
                        <div className="hero">
                            <div className="hero-content text-center text-neutral-content flex flex-col md:flex-row flex-wrap">
